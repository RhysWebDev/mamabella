<article @php(post_class('h-entry, bg-[#F6F9FB]'))>
        ...
        <div class="article__header max-w-[1118px] mx-auto pt-[3rem] px-[2rem] md:px-[0rem]">
            ...
            <div class="article__info flex mb-[2rem] justify-between">
                    ...
                    <div class="flex flex-col gap-y-[1rem] align-center">
                        <div class="flex-row flex gap-x-[5px] hearts">
                            @for ($i = 0; $i < get_field('rating'); $i++)
                                <svg xmlns="http://www.w3.org/2000/svg" width="22.191" height="23"
                                    viewBox="0 0 22.191 23">
                                    <path id="Icon_ionic-ios-heart" data-name="Icon ionic-ios-heart"
                                        d="M19.591,3.937h-.053a5.979,5.979,0,0,0-5.068,2.99A5.979,5.979,0,0,0,9.4,3.937H9.349a6.284,6.284,0,0,0-5.974,6.5,14.707,14.707,0,0,0,2.55,7.63,46.236,46.236,0,0,0,8.546,8.872,46.236,46.236,0,0,0,8.546-8.872,14.707,14.707,0,0,0,2.55-7.63A6.284,6.284,0,0,0,19.591,3.937Z"
                                        transform="translate(-3.375 -3.938)" fill="#b33558" />
                                </svg>
                            @endfor
                        </div>
                ...
                <div class="social-share flex flex-row gap-x-[10px]">
                    ...
                    <a href="https://twitter.com/share?url={{ $current_url }}&text=Check%20this%20out!"
                        target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 34 34">
            ...
            <img class="w-full aspect-video object-cover" src="{{ get_the_post_thumbnail_url() }}">
